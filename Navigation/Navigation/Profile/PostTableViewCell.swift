...
class PostTableViewCell: UITableViewCell {
    ...
    private func setupContent(){
        [contentMyView, postAuthor, postTitle, postImage, postDescription, postLikes, postViews].forEach {contentView.addSubview($0)}
        NSLayoutConstraint.activate([
            ...
            postTitle.topAnchor.constraint(equalTo: postAuthor.bottomAnchor, constant: 5),
            postTitle.leadingAnchor.constraint(equalTo: contentMyView.leadingAnchor, constant: 16),
